...
| `RAG_CONDENSE_TIMEOUT` | `45` | поводок вызова 1. Дефолт в коде 10 с — под стриминговый GigaChat |
| `RAG_GRADER_TIMEOUT` | `90` | поводок грейдера. Дефолт 20 с; на KitAI с его очередью грейдер по нему отваливался на каждом ходе, и отбор не работал вовсе |
