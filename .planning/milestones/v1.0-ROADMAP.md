...
- [x] **Phase 14: Infrastructure Hardening & Cleanup** - Docker volume persistence, unsafe cast fix, lint cleanup, docs (completed 2026-03-12)
...
| 14. Infrastructure Hardening & Cleanup | 3/3 | Complete   | 2026-03-12 |
...
**Success Criteria** (what must be TRUE):
  ...
  7. pnpm test passes all test suites without requiring OPENAI_API_KEY in shell environment
**Plans**: 3 plans
...
- [ ] 14-03-PLAN.md -- Gap closure: Fix test script to load .env automatically for embedding plugin validation
