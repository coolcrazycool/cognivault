...
- [x] **FILE-09**: Agent can update frontmatter fields without corrupting note content
...
- [x] **IDX-08**: Service extracts and indexes text from PDF files
