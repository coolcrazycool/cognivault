...
- [ ] **FILE-06**: Agent can delete note by path
...
- [ ] **API-04**: Service authenticates requests via API key (no role separation)
...
- [ ] **INF-06**: Service deploys as single Docker container alongside Qdrant via docker-compose
